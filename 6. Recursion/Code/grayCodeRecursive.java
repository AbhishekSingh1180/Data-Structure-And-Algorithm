...
class grayCodeRecursive
{
    static ArrayList<Integer> grayCodeDecimal(int N)
    {
    ...
    public static void main(String[] args) {
        for(String i:grayCodeBinary(3)) System.out.println(i);
        for(int i:grayCodeDecimal(3)) System.out.println(i);
    }
}
